...
var Character = function Character(_ref) {
    var animation = _ref.animation, armPath = _ref.armPath;
...
var ArmLeft = function ArmLeft(_ref2) {
    var animation = _ref2.animation, armPath = _ref2.armPath;
    return (
...
var ArmRight = function ArmRight(_ref3) {
    var animation = _ref3.animation, armPath = _ref3.armPath;
    return (
        React.createElement("svg", {className: "arm", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 300 400"},
            animation === "typing" &&
...
var
    ...
    App = function (_React$Component) {
        ...
        _createClass(App, [{
            key: "createCurve", value: function createCurve(
                x, offset) {
                var inverted = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
                var _state =
                        this.state, frequency = _state.frequency, ystart = _state.ystart, xstart = _state.xstart,
            ...
            key: "render", value: function render() {
                var _this3 = this;
                var _state4 =
                        this.state, frequency = _state4.frequency, amplitude = _state4.amplitude,
